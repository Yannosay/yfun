...
balls.push(spawnBall(300, 50, 30));
balls.push(spawnBall(100, 50, 30));
...
const spawnX = 200; // feste X-Position für Button
const spawnY = 150; // feste Y-Position für Button
const ballSize = 30;

// Button klick
document.getElementById('spawnBtn').addEventListener('click', () => {
    spawnBall(spawnX, spawnY, ballSize);
});
